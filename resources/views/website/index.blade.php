        ...
        <div class="hidden relative z-10 lg:block w-full">
            <div class="container max-w-full 2xl:mx-auto">
                <div class="w-full border-t border-b border-black/20 bg-white ">
                    ...
                    <div class="w-full h-full flex justify-evenly cursor-pointer p-4 lg:pl-8 lg:py-6 flex-col lg:flex-row xl:justify-left lg:items-center ">
                        <div class="relative z-50">
                            <div class="group inline-block">
                                <button class="menu-btn font-semibold">
                                    <h4>All Categories</h4>
                                </button>
                                <div
                                    class="hidden group-hover:block fixed left-0 top-[72px] w-full bg-white shadow-[0_20px_50px_rgba(0,0,0,0.15)] z-[9999]">
                                    <div class="max-w-7xl mx-auto px-6 py-8">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-h-[75vh] overflow-y-auto">
                                            @foreach ($departments as $department)
                                                @foreach ($department['master_categories'] as $masterCategory)
                                                    <div class="min-w-[220px]">
                                                        <h4 class="font-semibold text-gray-900 uppercase mb-3">
                                                            {{ $masterCategory['name'] }}
                                                        </h4>
                                                                    ...
                                                                    <ul class="mt-2 space-y-1">
                                                                        @foreach ($sectionType['categories'] as $category)
                                                                            <li>
                                                                                ...
                                                                                class="text-sm text-gray-700 hover:text-primary block whitespace-nowrap">
                                                                                    {{ $category['name'] }}
                                                                                </a>
                                                                            </li>
                                                                        @endforeach
                        ...
                        @foreach (array_slice($departments, 0, 7) as $department)
                            <div class="slide">
                                <div class="group relative inline-block">
                                    <button class="menu-btn">
                                        <h4>{{ $department['name'] }}</h4>
                                    </button>
                                    <div class="dropdown hidden group-hover:block absolute left-0 min-w-xl bg-white rounded-block shadow-[0_20px_50px_rgba(0,0,0,0.15)]">
                                        @foreach ($department['master_categories'] as $masterCategory)
