    ...
    <div class="hidden relative z-10 lg:block w-full">
        <div class="container max-w-full 2xl:mx-auto">
            <div class="w-full border-t border-b border-black/20 bg-white ">
                ...
                <div
                    class="w-full h-full flex justify-evenly cursor-pointer p-4 lg:pl-8 lg:py-6 flex-col lg:flex-row xl:justify-left lg:items-center ">
                    <div class="relative z-50">
                        <div class="group inline-block">
                            <button class="menu-btn font-semibold">
                                <h4>All Categories</h4>
                            </button>
                        <div class="dropdown hidden group-hover:block fixed inset-x-0 top-[72px]
                       bg-white shadow-[0_20px_50px_rgba(0,0,0,0.15)]
                       h-[calc(100vh-72px)] w-screen
