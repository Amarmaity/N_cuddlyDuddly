    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                @if ($seller->documents)
                    <a href="{{ route('admin.sellers.applications.viewDocs', $seller) }}"
            ...
            @if ($seller->compliance_status === 'pending')
                <div class="d-flex gap-3">
                    <!-- Approve -->
                    <form action="{{ route('admin.sellers.kyc.verify', $seller) }}" method="POST"
                    ...
                    <!-- Reject -->
                    <form action="{{ route('admin.sellers.kyc.reject', $seller) }}" method="POST"
