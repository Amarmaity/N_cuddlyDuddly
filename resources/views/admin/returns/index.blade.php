                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="text-end">
                            ...
                            <a href="{{ route('admin.returns.show', $return->id) }}"
                                class="btn btn-outline-primary btn-sm rounded-pill shadow-sm me-1" title="View Details">
                                <i class="bi bi-eye"></i>
                            </a>
                            @endcanAccess
        ...
        @if ($returns->hasPages())
            <div class="card-footer border-0 bg-white py-3 d-flex justify-content-between align-items-center">
                <div class="text-muted small">
                    Showing {{ $returns->firstItem() }} to {{ $returns->lastItem() }}
                    of {{ $returns->total() }} return requests
                </div>
