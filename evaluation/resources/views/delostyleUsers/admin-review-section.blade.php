                        ...
                        <div>
                            ...
                            <div class="mt-3"> <!-- Added margin-top for spacing -->
                                ...
                                <textarea name="comments_demonstrated_attendance" id="comments" class="form-control"
                                    rows="5" cols="50" maxlength="255" placeholder="Write your justification here..." required></textarea>
                            </div>
                            ...
                            <div class="mt-3"> <!-- Added margin-top for spacing -->
                                ...
                                <textarea name="comments_documentation_neatness" id="comments" class="form-control" rows="5"
                                    cols="50" maxlength="255" placeholder="Write your justification here..." required></textarea>
                            </div>
                            ...
                            <div class="mt-3"> <!-- Added margin-top for spacing -->
                                ...
                                maxlength="255" placeholder="Write your justification here..." required></textarea>
                            </div>
                            ...
                            <div class="mt-3"> <!-- Added margin-top for spacing -->
                                ...
                                maxlength="255"   cols="50" placeholder="Write your justification here..." required></textarea>
                            </div>
