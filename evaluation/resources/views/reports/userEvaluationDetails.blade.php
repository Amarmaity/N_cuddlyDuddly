...
<h2>Employee Evaluation Details</h2>
    ...
    <tbody>
        @foreach($eval as $evaluation)
            ...
            <tr>
                ...
                <td>{{ $evaluation->evaluator_signatur }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>{{$evaluation->work_motivation}} - {{$evaluation->comments_work_motivation}}<td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>{{$evaluation->director_signatur}}</td>
            </tr>
            <tr>
