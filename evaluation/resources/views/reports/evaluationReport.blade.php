...
<body>
    <div class="container">
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    <td>Employee performance and learning is unsatisfactory and is failing to improve at a satisfactory
                        rate</td>
    ...
    <script>
            ...
            // Get emp_id from Blade (e.g., passed in from controller)
            var emp_id = '{{ $user->emp_id ?? "" }}'; // fallback to empty string if not set
            ...
            // Use the emp_id to dynamically construct the route URL
