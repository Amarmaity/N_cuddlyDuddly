                ...
                <tbody>
                    ...
                    @foreach($superAddUser as $user)
                                    @php
                                        ...
                                        $review = $managerReviewTable->firstWhere('emp_id', $user->employee_id);
                                    @endphp
                                    @if($review) <!-- Only display if there is a review for the user -->
                                        <tr>
                                            ...
                                            <td>{{ $user->email }}</td>
                                            <td>
                                                <a href="{{ route('user-manager-details', $user->employee_id) }}" class="btn btn-primary">View
                                                    Details</a>
                                                <a href="{{route('user-report-view-evaluation', $user->employee_id)}}"
                                                    class="btn btn-primary">View Evaluation</a>
