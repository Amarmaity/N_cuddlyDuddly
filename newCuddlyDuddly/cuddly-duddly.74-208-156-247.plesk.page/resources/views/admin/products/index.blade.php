...
<h1>
    @section('title')
        {{ Auth::guard('seller')->check() ? 'My Products' : 'All Products' }}
    @endsection
</h1>
...
@section('content')
    ...
    <div class="mb-3 d-flex gap-2">
        ...
        @endif --}}
        @canAccess('admin.products.deleteSelected')
        <button class="btn btn-danger btn-sm" id="deleteSelected">
            <i class="bi bi-trash"></i> Delete Selected
        </button>
        @endcanAccess

        @canAccess('admin.products.featureSelected')
        <button class="btn btn-warning btn-sm" id="featureSelected">
            <i class="bi bi-star"></i> Feature Selected
        </button>
        @endcanAccess

        @canAccess('admin.products.approveSelected')
        <button class="btn btn-success btn-sm" id="approveSelected">
            <i class="bi bi-check2-circle"></i> Approve Selected
        </button>
        @endcanAccess
