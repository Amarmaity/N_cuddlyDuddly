...
@section('content')
    <div class="container-fluid py-3">
        ...
        <div class="card shadow-sm border-0 mb-3 p-2">
            <form method="GET" action="{{ route('admin.support.seller') }}" class="row g-3 align-items-end mb-3">
                <div class="col-md-4">
                            ...
                            <td>
                                @if($support->product)
                                    <div class="d-flex align-items-center">
                                        ...
                                        @if($support->product && $support->product->primaryImage)
                                            <img src="{{ asset('storage/' . $support->primaryImage->image_path) }}"
                                                alt="{{ $support->product->name }}" width="50" height="50" class="rounded me-2">
                                        @else
                                            <img src="{{ asset('storage/images/no-image.png') }}" width="50" height="50" class="rounded me-2">
                                        @endif
                    ...
                    <ul class="nav nav-tabs mb-3" id="supportTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages"
                                type="button">Conversation</button>
                        </li>
                            ...
                            <form id="productForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-start gap-3 p-2 border rounded">
                                        <!-- 🖼 Product Image -->
                                        <img id="productImage" src="{{ asset('storage/images/no-image.png') }}" width="100"
...
@push('scripts')
    <script src="{{ asset('js/seller-support.js') }}"></script>
@endpush